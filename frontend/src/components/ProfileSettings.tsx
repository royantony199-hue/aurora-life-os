...
import { Settings, Bell, Calendar, Shield, HelpCircle, LogOut, ChevronRight, Moon, Sun } from 'lucide-react';
  ...
  const menuItems = [
    {
      ...
      status: 'connected',
      action: () => {/* Handle calendar settings */}
    },
    {
      icon: Shield,
        ...
        <div className="flex items-center gap-4">
          <Avatar className="w-16 h-16">
            ...
            <AvatarFallback className="bg-[#4A90E2] text-white text-xl">
              {user ? getUserInitials(user.username) : 'AU'}
            </AvatarFallback>
          </Avatar>
          <div className="flex-1">
            ...
            <p className="text-sm text-[#8C8C8C]">
              {user ? user.email : 'demo@aurora.com'}
            </p>
